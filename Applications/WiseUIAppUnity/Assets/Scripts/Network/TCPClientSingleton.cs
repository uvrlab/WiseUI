...
public class TCPClientSingleton :MonoBehaviour
{
    ...
    static TCPClientSingleton _instance;
    public static TCPClientSingleton Instance
    {
        get
        {
            if (_instance == null)
            {
                GameObject obj = GameObject.Find("TCPClientManager");
                if (obj == null)
                {
                    obj = new GameObject("TCPClientManager");
                    _instance = obj.AddComponent<TCPClientSingleton>();
